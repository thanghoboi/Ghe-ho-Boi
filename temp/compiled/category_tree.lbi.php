				...
				<div class="sub_cat_lv1">
					<div class="inner_lv1">
						<ul class="level_2 clearfix">
							<?php $_from = $this->_var['cat']['cat_id']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'child_0_30930400_1377011187');$this->_foreach['child_cat'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['child_cat']['total'] > 0):
    foreach ($_from AS $this->_var['child_0_30930400_1377011187']):
...
?>
							<li class="level_2 clearfix<?php if (($this->_foreach['child_cat']['iteration'] <= 1)): ?> level_2_first<?php endif; ?>">
								<a href="<?php echo $this->_var['child_0_30930400_1377011187']['url']; ?>" class="level_2"><span><?php echo $this->_var['child_0_30930400_1377011187']['name']; ?></span></a>
								<?php if ($this->_var['child_0_30930400_1377011187']['cat_id']): ?>
								<div class="sub_cat_lv2">
									<div class="inner_lv2">
										<div class="arrow"></div>
										<ul class="level_3 clearfix">
											<?php $_from = $this->_var['child_0_30930400_1377011187']['cat_id']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'childer');$this->_foreach['childer_cat'] = array('total' => count($_from), 'iteration' => 0);

...
?>
			...
			<?php $_from = $this->_var['title']['options']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item_0_58288200_1377011187');if (count($_from)):
    foreach ($_from AS $this->_var['item_0_58288200_1377011187']):
?>
			<?php if ($this->_var['title']['can_multi'] == 0): ?>
			<label for="option_id_<?php echo $this->_var['item_0_58288200_1377011187']['option_id']; ?>"><input type="checkbox" name="option_id" value="<?php echo $this->_var['item_0_58288200_1377011187']['option_id']; ?>" id="option_id_<?php echo $this->_var['item_0_58288200_1377011187']['option_id']; ?>"/><?php echo $this->_var['item_0_58288200_1377011187']['option_name']; ?><em>(<?php echo $this->_var['item_0_58288200_1377011187']['percent']; ?>%)</em></label>
			<?php else: ?>
			<label for="option_id_<?php echo $this->_var['item_0_58288200_1377011187']['option_id']; ?>"><input type="radio" name="option_id" value="<?php echo $this->_var['item_0_58288200_1377011187']['option_id']; ?>" id="option_id_<?php echo $this->_var['item_0_58288200_1377011187']['option_id']; ?>"/><?php echo $this->_var['item_0_58288200_1377011187']['option_name']; ?><em>(<?php echo $this->_var['item_0_58288200_1377011187']['percent']; ?>%)</em></label>
			<?php endif; ?>
